...
public class Medium {
    ...
    public static int cx = GameFacts.resWidth / 2;
    public static int cy = GameFacts.resHeight / 2;
    ...
    public static int w = GameFacts.resWidth;
    public static int h = GameFacts.resHeight;
